...
- Optimize finite-difference coefficients per speed/curvature bucket without tree models.
- Add a small differentiable coefficient model that predicts only 2-5 motion coefficients, not free 3D residuals.
