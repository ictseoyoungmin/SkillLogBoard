...
slice: "03_monitoring_jsonl_schema"
title: "monitoring jsonl schema"
priority: "P0"
status: "completed"
target_version: "v1.0-live-board"
---

# 03_monitoring_jsonl_schema — monitoring jsonl schema

## Objective

Define `monitoring.jsonl` record schema and append/read helpers.
...
- src/skilllogboard/live/monitoring.py
- tests/test_live_monitoring.py

## Implementation Steps

1. Define monitoring record fields: timestamp, source, type, metrics.
2. Implement append/read helpers.
3. Support sources: system, gpu, process.
4. Read helper should support tail limit.
5. Add tests for JSONL append/read.

## Acceptance Criteria

- `monitoring.jsonl` records are valid JSONL.
- Append/read roundtrip works.
...
```bash
pytest -q tests/test_live_monitoring.py
```
