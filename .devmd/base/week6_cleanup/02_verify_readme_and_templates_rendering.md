...
**Verification command(s):** .venv/bin/python -c "README/templates rendering checks"; .venv/bin/pytest -q tests/test_examples.py tests/test_cli_templates.py
**Notes:** README and docs/templates.md already distinguished implemented and planned templates with valid Markdown table structure.
