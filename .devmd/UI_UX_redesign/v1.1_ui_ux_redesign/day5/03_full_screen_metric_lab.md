...
day: "day5"
slice: "03_full_screen_metric_lab"
title: "full-screen metric lab"
priority: "P0"
status: "completed"
target_version: "v1.1-ui-ux-redesign"
---

# 03_full_screen_metric_lab — full-screen metric lab

## Objective

Add expanded Metric Lab view for advanced analysis without overloading default UI.
...
1. Add Expand/Metric Lab action.
2. Implement full-screen or large overlay view.
3. Include selected metrics, compare controls, markers, smoothing, scale, and legend.
4. Add close/escape affordance.
5. Add tests.

## Acceptance Criteria

- Metric Lab entry point exists.
- Expanded chart view exists.
- Close affordance exists.
