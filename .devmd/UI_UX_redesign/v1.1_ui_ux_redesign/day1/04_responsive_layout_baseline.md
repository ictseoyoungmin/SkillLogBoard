...
day: "day1"
slice: "04_responsive_layout_baseline"
...
# 04_responsive_layout_baseline — responsive layout baseline

## Objective

Ensure the redesigned UI works on laptop and narrower screens.
...
2. Collapse side rail labels on narrow screens.
3. Make drawer full-width overlay on narrow screens.
4. Avoid horizontal overflow from long metric/run names.
5. Add tests for responsive CSS markers.

## Acceptance Criteria

- Responsive CSS exists.
- Side rail/drawer behavior is defined.
- Required panels remain reachable.
- Tests pass.
