...
day: "day1"
slice: "02_minimal_shell_information_architecture"
title: "minimal shell information architecture"
priority: "P0"
status: "completed"
target_version: "v1.1-ui-ux-redesign"
---

# 02_minimal_shell_information_architecture — minimal shell information architecture

## Objective

Redesign the Live Board shell so default information density is low and hierarchy is clear.
...
1. Define topbar, compact left rail, main workspace, right drawer, and bottom tray.
2. Reduce default KPI cards to status, primary metric, alert count, and resource health.
3. Move events/rules/logs/system/artifacts into collapsed tray or drawers.
4. Add visible actions: Add metric, Compare, Open details, Expand.
5. Add tests for layout landmarks.

## Acceptance Criteria

- Default layout is not card-dense.
- Main metric workspace is visually dominant.
- Detail panels are collapsed or drawer-based by default.
- Tests pass.
