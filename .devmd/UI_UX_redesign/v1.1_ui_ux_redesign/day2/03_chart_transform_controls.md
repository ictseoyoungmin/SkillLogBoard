...
day: "day2"
slice: "03_chart_transform_controls"
title: "chart transform controls"
priority: "P0"
status: "completed"
target_version: "v1.1-ui-ux-redesign"
---

# 03_chart_transform_controls — chart transform controls

## Objective

Add smoothing, scale, and x-axis alignment controls for metric exploration.
...
1. Add compact controls for smoothing, y-scale, and x-axis alignment.
2. Implement lightweight smoothing in vanilla JS.
3. Use step as default x-axis alignment.
4. Disable or document unsupported modes.
5. Keep controls hidden/compact by default.
6. Add tests for control markup.

## Acceptance Criteria

- Smoothing control exists.
- Scale/alignment controls are present or clearly disabled/documented.
- Default screen remains uncluttered.
- Tests pass.
