...
day: "day2"
slice: "04_event_rule_marker_model"
title: "event and rule marker model"
priority: "P0"
status: "completed"
target_version: "v1.1-ui-ux-redesign"
---

# 04_event_rule_marker_model — event and rule marker model

## Objective

Prepare chart marker data for events, checkpoints, and rule warnings/errors.
...
1. Derive `chart_markers` from events and skill trace records.
2. Include marker type, severity, label, step/time, and source.
3. Do not modify original events/rules fields.
4. Render marker affordance near/on chart if possible.
5. Add tests.

## Acceptance Criteria

- Live state includes chart marker data or equivalent.
- Rule warnings/errors and checkpoint/eval events can become markers.
- Existing events/rules UI remains compatible.
- Tests pass.

## Verification Commands

```bash
pytest -q tests/test_live_state.py tests/test_live_ui_snapshot.py
```
