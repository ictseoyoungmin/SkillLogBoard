...
day: "day4"
slice: "03_compare_alignment_normalization_controls"
title: "compare alignment and normalization controls"
priority: "P0"
status: "completed"
target_version: "v1.1-ui-ux-redesign"
---

# 03_compare_alignment_normalization_controls — compare alignment and normalization controls

## Objective

Add compare controls for alignment, smoothing, raw/normalized values, and top-k limits.
...
1. Add alignment control: step, epoch, wall-time where supported.
2. Add raw/normalized toggle or documented staged control.
3. Reuse smoothing control.
4. Add selected-only/top-k policy copy.
5. Document limitations for unavailable epoch/time fields.
6. Add tests.

## Acceptance Criteria

- Compare controls are present and documented.
- Unsupported modes are disabled or explained.
- Raw/normalized toggle exists or is deferred with docs.
- Tests pass.
