...
day: "day4"
slice: "04_project_overview_minimal_cards"
title: "project overview minimal cards"
priority: "P0"
status: "completed"
target_version: "v1.1-ui-ux-redesign"
---

# 04_project_overview_minimal_cards — project overview minimal cards

## Objective

Redesign project overview to focus on active runs, best run, alerts, and resource health.
...
1. Reduce top cards to Active Runs, Best Run, Alerts, Resource Health.
2. Move detailed run table into expandable region.
3. Add filters: running, failed, completed, alerting.
4. Add click target to open run details/compare.
5. Add tests.

## Acceptance Criteria

- Project overview is less cluttered.
- Detailed table is available but not dominant.
