...
day: "day4"
slice: "02_compare_overlay_ui"
title: "compare overlay UI"
priority: "P0"
status: "completed"
target_version: "v1.1-ui-ux-redesign"
---

# 02_compare_overlay_ui — compare overlay UI

## Objective

Implement Compare Mode UI with run picker, overlay chart, and legend controls.
...
1. Add Compare Mode toggle near Metric Workspace.
2. Add compact run picker/drawer.
3. Render overlay chart for selected metric across selected runs.
4. Add legend with per-run visibility toggles.
5. Label current/baseline/best where known.
6. Add tests.

## Acceptance Criteria

- Compare Mode is visible and discoverable.
- Run picker exists.
- Overlay legend exists.
- User can hide/show individual runs in frontend state.
- Tests pass.
