...
day: "day3"
slice: "02_metric_selector_catalog_ui"
title: "metric selector and catalog UI"
priority: "P0"
status: "completed"
target_version: "v1.1-ui-ux-redesign"
---

# 02_metric_selector_catalog_ui — metric selector and catalog UI

## Objective

Implement compact grouped metric selector with search and pin affordance.
...
1. Render grouped metric catalog.
2. Add metric name search/filter input.
3. Add pin/unpin affordance.
4. Show selected metric chips.
5. Keep selector closed/compact by default.
6. Add tests.

## Acceptance Criteria

- Grouped metric selector exists.
- Search/filter UI exists.
- Pinned metric chips exist.
