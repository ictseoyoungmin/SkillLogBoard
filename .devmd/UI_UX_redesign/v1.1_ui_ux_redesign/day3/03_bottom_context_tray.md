...
day: "day3"
slice: "03_bottom_context_tray"
title: "bottom context tray"
priority: "P0"
status: "completed"
target_version: "v1.1-ui-ux-redesign"
---

# 03_bottom_context_tray — bottom context tray

## Objective

Move events, rules, system, and logs into a collapsed bottom tray.
...
1. Create bottom tray with Events, Rules, System, Logs tabs.
2. Default tray state is collapsed/compact.
3. Add expand/collapse controls.
4. Ensure all context content remains accessible.
5. Use accessible button/tab markup.
6. Add tests.

## Acceptance Criteria

- Bottom tray exists.
- Tray is collapsed/compact by default.
