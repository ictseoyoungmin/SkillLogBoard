...
day: "day3"
slice: "01_metric_workspace_layout"
title: "metric workspace layout"
priority: "P0"
status: "completed"
target_version: "v1.1-ui-ux-redesign"
---

# 01_metric_workspace_layout — metric workspace layout

## Objective

Implement the chart-first Metric Workspace for single-run mode.
...
1. Create main Metric Workspace region.
2. Add metric selector/search, selected metric title, latest value, trend delta, and status chip.
3. Render chart using local SVG/canvas/HTML approach.
4. Move full metric list into selector/drawer.
5. Add tests for workspace elements.

## Acceptance Criteria

- Metric Workspace is dominant.
- Metric selector/search is visible.
- Selected metric summary is visible.
- Full metric list is not expanded by default.
- Tests pass.
