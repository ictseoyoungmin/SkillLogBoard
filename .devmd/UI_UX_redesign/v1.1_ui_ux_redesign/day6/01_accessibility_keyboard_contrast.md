...
day: "day6"
slice: "01_accessibility_keyboard_contrast"
...
# 01_accessibility_keyboard_contrast — accessibility keyboard and contrast

## Objective

Improve keyboard navigation, ARIA labels, focus states, and contrast.
...
1. Add accessible labels for buttons, drawers, tabs, and metric controls.
2. Ensure focus-visible styles exist.
3. Use buttons/links for interactive controls.
4. Add keyboard close behavior for drawers/modals if feasible.
5. Check contrast for text and severity chips.
6. Add tests.

## Acceptance Criteria

- Main controls have accessible names.
- Focus styles are visible.
- Drawers/modals/tabs have roles or labels.
