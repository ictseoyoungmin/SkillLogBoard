...
**Verification command(s):** .venv/bin/python -c "release decision record check"
**Notes:** Added go/no-go decision record. Candidate is GO for v0.6 release-candidate handoff, with isolated build confirmation deferred to CI/Docker before publishing.
