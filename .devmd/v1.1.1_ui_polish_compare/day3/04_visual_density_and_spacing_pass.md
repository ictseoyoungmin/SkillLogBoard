...
day: "day3"
slice: "04_visual_density_and_spacing_pass"
title: "visual density and spacing pass"
priority: "P0"
status: "completed"
target_version: "v1.1.1-ui-polish-compare"
---

# 04_visual_density_and_spacing_pass — visual density and spacing pass

## Objective

Perform a design pass on spacing, typography, and panel density.
...
1. Define spacing scale and use it consistently.
2. Reduce duplicate borders and excessive card outlines.
3. Refine typography hierarchy for topbar, workspace title, section labels, and metadata.
4. Ensure long run names and metric names truncate gracefully.
5. Add design guideline notes for density rules.

## Acceptance Criteria

- Spacing and typography are consistent.
- Long names do not break layout.
- Design guideline documents the density rules.
- Tests pass.
