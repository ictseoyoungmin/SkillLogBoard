...
day: "day3"
slice: "05_loading_transition_and_refresh_feedback"
title: "loading transition and refresh feedback"
priority: "P0"
status: "completed"
target_version: "v1.1.1-ui-polish-compare"
---

# 05_loading_transition_and_refresh_feedback — loading transition and refresh feedback

## Objective

Improve feedback during polling and API refresh without distracting users.
...
1. Add subtle last-updated indicator.
2. Add quiet refresh pulse or status text.
3. Avoid jarring full-screen loading after initial load.
4. Keep API error state visible but non-destructive.
5. Add tests for last-updated/refresh indicators.

## Acceptance Criteria

- Users can see that the board is refreshing.
- Refresh feedback is subtle.
- Initial and subsequent loading states are distinct.
- Tests pass.
