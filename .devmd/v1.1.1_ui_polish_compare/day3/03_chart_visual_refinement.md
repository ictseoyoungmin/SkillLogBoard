...
day: "day3"
slice: "03_chart_visual_refinement"
title: "chart visual refinement"
priority: "P0"
status: "completed"
target_version: "v1.1.1-ui-polish-compare"
---

# 03_chart_visual_refinement — chart visual refinement

## Objective

Improve chart aesthetics, readability, and visual hierarchy.
...
1. Refine grid opacity, axis labels, line weight, marker styling, hover title text, and legend spacing.
2. Add selected metric title and latest value near chart.
3. Show small trend indicator if enough points exist.
4. Keep chart clear with many points or multiple selected metrics.
5. Ensure color palette supports at least 6 overlay runs.
6. Add snapshot tests for chart labels/legend/palette tokens.

## Acceptance Criteria

- Chart area is visually clearer.
- Axis/metric labels are present or intentionally minimal.
- Overlay palette supports multiple runs.
- No external chart library is added.
- Tests pass.
