...
day: "day6"
slice: "03_accessibility_interaction_pass"
...
# 03_accessibility_interaction_pass — accessibility interaction pass

## Objective

Refine keyboard and screen-reader affordances after compare/tray/drawer changes.
...
1. Ensure compare toggle, tray toggle, side panel toggle, drawer close, metric lab close, run picker, and legend controls have accessible names.
2. Use `aria-expanded` for collapsible panels.
3. Use `aria-pressed` for toggle buttons.
4. Ensure focus-visible styles remain visible.
5. Add snapshot tests for ARIA states.

## Acceptance Criteria

- Interactive controls have accessible names.
- `aria-expanded` and `aria-pressed` are used appropriately.
