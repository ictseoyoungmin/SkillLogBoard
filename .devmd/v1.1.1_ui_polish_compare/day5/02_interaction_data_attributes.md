...
day: "day5"
slice: "02_interaction_data_attributes"
title: "stable interaction data attributes"
priority: "P0"
status: "completed"
target_version: "v1.1.1-ui-polish-compare"
---

# 02_interaction_data_attributes — stable interaction data attributes

## Objective

Add stable data attributes for important UI regions and controls to support robust tests.
...
1. Add stable data attributes for metric workspace, compare toggle, run picker, overlay legend, bottom tray, side panel, detail drawer, artifact browser, agent workspace, and metric lab.
2. Update tests to assert data attributes rather than fragile text where possible.
3. Avoid changing visible UI solely for testing.
4. Document a small convention in comments or design guideline if useful.

## Acceptance Criteria

- Major interactive regions have stable data attributes.
- Snapshot tests use stable markers.
- Visible UI is not polluted with test-only text.
- Tests pass.
