...
day: "day4"
slice: "02_artifact_type_grouping"
title: "artifact type grouping"
priority: "P0"
status: "completed"
target_version: "v1.1.1-ui-polish-compare"
---

# 02_artifact_type_grouping — artifact type grouping

## Objective

Group artifacts into reports, figures, tables, checkpoints, logs, and other.
...
1. Define artifact type inference based on path, extension, and known report package layout.
2. Group artifacts in state or frontend rendering.
3. Show group labels in artifact browser.
4. Keep raw artifact list available for backward compatibility.
5. Add tests for png, csv, md, html, yaml, checkpoint-like files.

## Acceptance Criteria

- Artifacts are grouped by type.
- Report figures and tables are correctly classified.
...
```bash
pytest -q tests/test_live_readers.py tests/test_live_ui_snapshot.py
```
