...
day: "day7"
slice: "04_ci_and_full_regression"
title: "CI and full regression"
priority: "P1"
status: "completed"
target_version: "v1.1.1-ui-polish-compare"
---

# 04_ci_and_full_regression — CI and full regression

## Objective

Run full regression after v1.1.1 changes.
...
- tests/
- .devmd/v1.1.1_ui_polish_compare/**/*.md
...
4. Run report-extra tests if report extra exists.
5. Run examples.
6. Run no-isolation build.
7. Confirm GitHub Actions green after push.
8. Record exact verification commands.
...
- Full pytest passes.
- Live subset passes.
- Report-extra subset passes or is documented as deferred.
- Examples pass.
