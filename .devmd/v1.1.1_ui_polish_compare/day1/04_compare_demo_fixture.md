...
day: "day1"
slice: "04_compare_demo_fixture"
title: "compare demo fixture"
priority: "P0"
status: "completed"
target_version: "v1.1.1-ui-polish-compare"
---

# 04_compare_demo_fixture — compare demo fixture

## Objective

Create reliable multi-run demo data for compare mode testing and manual QA.
...
1. Update or add demo mode that creates at least three runs under a project root.
2. Each run should log shared metrics such as train/loss and val/acc plus one unique metric.
3. Use varied status values: completed, running, failed if appropriate.
4. Create events/rules/artifacts sufficient for context marker and artifact UI.
5. Document how to run project compare demo.

## Acceptance Criteria

- Demo can generate multiple comparable runs.
- Shared metrics are available across runs.
- Project mode can use the demo output.
- Example runtime remains short.
