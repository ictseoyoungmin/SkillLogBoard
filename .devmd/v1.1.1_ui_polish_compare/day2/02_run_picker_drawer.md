...
day: "day2"
slice: "02_run_picker_drawer"
title: "run picker drawer"
priority: "P0"
status: "completed"
target_version: "v1.1.1-ui-polish-compare"
---

# 02_run_picker_drawer — run picker drawer

## Objective

Implement a compact run picker for selecting overlay runs.
...
1. Add run picker area inside side panel or compare drawer.
2. Render compare candidates with run name, status, best metric, and role badges.
3. Allow selecting/deselecting runs in frontend state.
4. Limit selected runs to a sensible default such as 5.
5. Add empty state for no compare candidates.
6. Add snapshot tests for run picker labels/classes.

## Acceptance Criteria

- Run picker exists.
- Selected runs can be represented in frontend state.
- Role badges such as best/latest are visible when available.
- Selection limit is enforced or documented.
- Tests pass.
