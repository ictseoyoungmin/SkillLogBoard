...
day: "day1"
slice: "04_demo_report_artifacts_and_agent_evidence"
title: "demo report artifacts and agent evidence"
priority: "P0"
status: "completed"
target_version: "v1.1.2-showcase-visual-parity"
---

# 04_demo_report_artifacts_and_agent_evidence — demo report artifacts and agent evidence

## Objective

Populate rich demo with report artifacts and agent evidence so drawers are not empty.
...
1. Ensure rich demo writes report-like files under report/ if actual report builder is not sufficient.
2. Create small figure/table placeholder artifacts using safe text/csv/svg/png only if supported.
3. Create minimal agent/actions.jsonl, agent/decisions.md, and agent/handoff.md in rich mode.
4. Do not create misleading fake results; label demo artifacts as synthetic.
5. Add tests for report_artifacts and agent_workspace fields.

## Acceptance Criteria

- Report artifact browser has demo content.
- Agent Workspace has demo evidence.
- Synthetic nature is clear in file names or content.
- Tests pass.
