...
day: "day3"
slice: "03_chart_affordance_and_marker_polish"
title: "chart affordance and marker polish"
priority: "P0"
status: "completed"
target_version: "v1.1.2-showcase-visual-parity"
---

# 03_chart_affordance_and_marker_polish — chart affordance and marker polish

## Objective

Improve chart affordances so users understand interactions and context markers.
...
1. Add compact legend explaining line, marker, warning/event marker if markers exist.
2. Improve hover/title text for SVG lines and markers.
3. Show metric axis labels or value range when useful.
4. Ensure log scale warning appears for non-positive values if applicable.
5. Add tests for chart affordance text/classes.

## Acceptance Criteria

- Chart has clearer affordances.
- Markers are understandable.
