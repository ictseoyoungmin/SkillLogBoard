...
day: "day5"
slice: "02_showcase_interaction_tests"
title: "showcase interaction tests"
priority: "P0"
status: "completed"
target_version: "v1.1.2-showcase-visual-parity"
---

# 02_showcase_interaction_tests — showcase interaction tests

## Objective

Strengthen HTML/JS contract tests for showcase and visual parity elements.
...
1. Add tests for capability hints region.
2. Add tests for guided empty states.
3. Add tests for rich compare markers.
4. Add tests for artifact/agent showcase elements.
5. Add tests for onboarding/help action.
6. Use stable data attributes where possible.

## Acceptance Criteria

- Tests protect showcase UI elements.
- Tests remain robust to copy tweaks.
- Tests pass.
