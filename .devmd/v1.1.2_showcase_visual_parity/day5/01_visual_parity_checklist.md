...
day: "day5"
slice: "01_visual_parity_checklist"
title: "visual parity checklist"
priority: "P0"
status: "completed"
target_version: "v1.1.2-showcase-visual-parity"
---

# 01_visual_parity_checklist — visual parity checklist

## Objective

Create a checklist comparing implementation against the intended mockup direction.
...
1. Add visual parity checklist for minimal overview, metric workspace, compare overlay, drawers, artifact browser, agent workspace.
2. Include pass/fail criteria for density, hierarchy, spacing, affordance, and empty states.
3. Keep checklist practical for manual QA.

## Acceptance Criteria

- Visual parity checklist exists.
- Checklist covers all major UI states.
- Checklist uses concrete criteria.
...
assert 'visual parity' in text
print('visual parity checklist check passed')
PY
```
