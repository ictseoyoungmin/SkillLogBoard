...
day: "day8"
slice: "04_release_candidate_note_v15"
title: "release candidate note v1.5"
priority: "P1"
status: "completed"
target_version: "v1.5"
---

# 04_release_candidate_note_v15 — release candidate note v1.5

## Objective

Prepare v1.5 release candidate note.
...
1. Summarize performance and operational maturity features.
2. List manual QA commands.
3. List safety constraints and non-goals.
4. List destructive action guardrails.
5. Do not publish.

## Acceptance Criteria

- v1.5 RC note exists.
- Safety guardrails are listed.
...
text = Path('docs/v1_5_release_candidate_note.md').read_text(encoding='utf-8').lower()
assert 'retention' in text and 'agent' in text and 'performance' in text
print('v1.5 RC note check passed')
PY
```
...
- B1: docs/v1_5_release_candidate_note.md added.
- B2: Release checklist includes index, filters, lazy series, retention, rotation, handoff, tests, and build.
- B3: Safety constraints and guardrails are listed.
