...
day: "day6"
slice: "02_agent_decision_policy"
title: "agent warning/error decision policy"
priority: "P0"
status: "completed"
target_version: "v1.5"
---

# 02_agent_decision_policy — agent warning/error decision policy

## Objective

Define agent behavior for warning/error outcomes.
...
- src/skilllogboard/agent/policy.py
- docs/agent_research_layer.md
- tests/test_agent_policy.py

## Implementation Steps

1. Define continue, retry, fix-and-retry, escalate, stop outcomes.
2. Map rule warning/error severities to recommended actions.
3. Support override in policy file.
4. Add tests.

## Acceptance Criteria

- Decision policy exists.
- Warnings/errors map to actions.
- Tests pass.

## Verification Commands

```bash
pytest -q tests/test_agent_policy.py
```
...
- B1: src/skilllogboard/agent/policy.py maps validation status/severity/retries to continue/retry/fix-and-retry/escalate/stop.
- B2: tests/test_v15_retention_agent.py verifies escalation on repeated errors.
- B3: docs/operational_rules.md documents agent guardrails.
