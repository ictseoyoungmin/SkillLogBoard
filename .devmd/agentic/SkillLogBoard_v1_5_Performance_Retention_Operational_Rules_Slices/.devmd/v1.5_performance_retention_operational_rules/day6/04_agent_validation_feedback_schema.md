...
day: "day6"
slice: "04_agent_validation_feedback_schema"
title: "agent validation feedback schema"
priority: "P0"
status: "completed"
target_version: "v1.5"
---

# 04_agent_validation_feedback_schema — agent validation feedback schema

## Objective

Create structured validation feedback schema for agents.
...
1. Define feedback fields: status, errors, warnings, code, path, message, suggested_action.
2. Use schema in template/report validation where feasible.
3. Add tests.

## Acceptance Criteria

- Agent-readable feedback schema exists.
- At least one validator can emit it or docs explain planned integration.
- Tests pass.

## Verification Commands

```bash
pytest -q tests/test_agent_feedback.py
```
...
- B1: src/skilllogboard/agent/feedback.py defines status/errors/warnings/code/path/message/suggested_action output.
- B2: skilllog forge validate --feedback-json and skilllog report validate --feedback-json added.
- B3: tests/test_v15_retention_agent.py verifies feedback records.
