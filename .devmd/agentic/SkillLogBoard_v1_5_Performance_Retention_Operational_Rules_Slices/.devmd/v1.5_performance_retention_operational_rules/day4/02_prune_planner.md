...
- B1: src/skilllogboard/retention/planner.py plans keep/archive/delete candidates with reasons.
- B2: Planner protects latest, best, baseline, and excluded tags.
- B3: tests/test_v15_retention_agent.py verifies baseline protection.
