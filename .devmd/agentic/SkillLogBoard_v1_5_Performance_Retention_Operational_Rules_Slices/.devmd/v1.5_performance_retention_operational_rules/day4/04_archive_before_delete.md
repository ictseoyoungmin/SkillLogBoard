...
day: "day4"
slice: "04_archive_before_delete"
...
# 04_archive_before_delete — archive before delete

## Objective

Implement optional archive-before-delete workflow.
...
- src/skilllogboard/retention/archive.py
- src/skilllogboard/cli/main.py
- tests/test_retention_archive.py

## Implementation Steps

1. Create archive zip/tar helper for selected runs.
2. Record archive manifest.
3. Do not delete unless explicit destructive flag is provided.
4. Add tests.

## Acceptance Criteria

- Archive helper exists.
- Archive manifest is produced.
...
```bash
pytest -q tests/test_retention_archive.py
```
...
- B1: src/skilllogboard/retention/archive.py writes zip archives with archive_manifest.json.
- B2: RetentionPolicy archive_before_delete defaults to True.
- B3: docs/operational_rules.md states deletion requires explicit external retention runner.
