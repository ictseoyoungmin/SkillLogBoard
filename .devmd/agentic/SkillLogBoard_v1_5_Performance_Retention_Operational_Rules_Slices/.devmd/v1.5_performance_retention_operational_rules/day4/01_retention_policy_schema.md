...
day: "day4"
slice: "01_retention_policy_schema"
...
# 01_retention_policy_schema — retention policy schema

## Objective

Define retention/pruning policy schema.
...
1. Define keep_best, keep_latest, older_than, exclude_tags, protect_baseline, artifact rules.
2. Set dry-run as default behavior.
3. Define archive-before-delete option.
4. Add tests.
...
- B1: src/skilllogboard/retention/policy.py defines RetentionPolicy and CheckpointRetentionPolicy.
- B2: Policy defaults to dry_run=True and archive_before_delete=True.
- B3: tests/test_v15_retention_agent.py verifies dry-run planning behavior.
