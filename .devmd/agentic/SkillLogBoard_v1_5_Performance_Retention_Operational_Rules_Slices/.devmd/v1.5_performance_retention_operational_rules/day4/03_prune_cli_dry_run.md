...
- B1: skilllog prune PROJECT_DIR added and defaults to dry-run.
- B2: CLI supports --dry-run, --execute, --json, and retention options.
- B3: README.md and docs/operational_rules.md document dry-run default.
