...
day: "day1"
slice: "03_metric_summary_cache_schema"
title: "metric summary cache schema"
priority: "P0"
status: "completed"
target_version: "v1.5"
---

# 03_metric_summary_cache_schema — metric summary cache schema

## Objective

Define metric summary cache schema for fast Overview/Runs views.
...
- tests/test_metric_summary_cache.py
- docs/operational_rules.md

## Implementation Steps

1. Define per-run metric summary: metric name, point count, first/last step, min, max, last value, best value if applicable.
2. Store source file mtime/hash.
3. Mark cache as derived.
4. Add tests.

## Acceptance Criteria

- Metric summary schema exists.
- Summary supports Overview/Runs without full series.
- Tests pass.

## Verification Commands

```bash
pytest -q tests/test_metric_summary_cache.py
```
...
- B1: src/skilllogboard/index/metrics.py stores count, first/last step, min/max, last_value, best, source mtime, and source hash.
- B2: tests/test_v15_index_query.py verifies best metric summary output.
- B3: live project summary remains summary-first.
