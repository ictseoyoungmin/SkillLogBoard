...
day: "day7"
slice: "02_template_forge_feedback_integration"
title: "Template Forge validation feedback integration"
priority: "P0"
status: "completed"
target_version: "v1.5"
---

# 02_template_forge_feedback_integration — Template Forge validation feedback integration

## Objective

Integrate structured feedback with Template Forge validation.
...
- src/skilllogboard/agent/feedback.py
- tests/test_template_forge.py

## Implementation Steps

1. Map template validation failures into structured feedback.
2. Include suggested_action for common failures.
3. Keep human-readable CLI output.
4. Add tests.

## Acceptance Criteria

- Template validation can produce agent-readable feedback.
...
```bash
pytest -q tests/test_template_forge.py tests/test_agent_feedback.py
```
...
- B1: skilllog forge validate --feedback-json maps TemplateValidationResult to agent feedback.
- B2: src/skilllogboard/agent/feedback.py preserves human-readable validation output separately.
- B3: Existing template forge validator regression tests pass.
