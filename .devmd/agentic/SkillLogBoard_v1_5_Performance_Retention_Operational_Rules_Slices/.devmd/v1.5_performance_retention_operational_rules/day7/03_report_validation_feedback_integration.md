...
day: "day7"
slice: "03_report_validation_feedback_integration"
title: "Report validation feedback integration"
priority: "P0"
status: "completed"
target_version: "v1.5"
---

# 03_report_validation_feedback_integration — Report validation feedback integration

## Objective

Integrate structured feedback with report validation.
...
1. Map report validation errors into feedback schema.
2. Include path and suggested_action.
3. Support JSON CLI output if available.
4. Add tests.

## Acceptance Criteria

- Report validation emits structured feedback.
- Tests pass.

## Verification Commands

```bash
pytest -q tests/test_cli_report.py tests/test_agent_feedback.py
```
...
- B1: skilllog report validate --feedback-json maps ReportValidationResult to agent feedback.
- B2: Existing report validation JSON remains available through --json.
- B3: Report regression tests pass.
