...
day: "day3"
slice: "01_run_tag_schema"
title: "run tag/group schema"
priority: "P0"
status: "completed"
target_version: "v1.5"
---

# 01_run_tag_schema — run tag/group schema

## Objective

Add tag/group/baseline metadata schema for runs.
...
- src/skilllogboard/schema.py
- src/skilllogboard/index/builder.py
- tests/test_run_tags.py
- docs/operational_rules.md

## Implementation Steps

1. Define optional run tags and group fields.
2. Define baseline/reference role field.
3. Read tags from manifest or sidecar metadata.
4. Add tests.

## Acceptance Criteria

- Runs can carry tags/groups.
- Baseline role can be represented.
- Tests pass.

## Verification Commands

```bash
pytest -q tests/test_run_tags.py
```
...
- B1: Project/run summaries carry tags, group, and baseline fields from manifest metadata.
- B2: Project index records tags/group/baseline in ProjectIndexRun.
- B3: tests/test_v15_index_query.py verifies tag/group/baseline indexing.
