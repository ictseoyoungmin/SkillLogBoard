...
day: "day6"
slice: "01_offline_render_smoke"
title: "offline render smoke tests"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 01_offline_render_smoke — offline render smoke tests

## Objective

Add smoke tests that render and open static reports without network dependencies.
...
1. Render minimal and package reports in a temp directory.
2. Assert output files exist.
3. Assert no http/https external assets in minimal/package outputs.
4. Assert relative figure/table links resolve.

## Acceptance Criteria

- Offline render smoke tests exist.
- No external network dependency is present.
- Links resolve.
- Tests pass.
...
```bash
pytest -q tests/test_report_rendering.py tests/test_report_assets.py
```
