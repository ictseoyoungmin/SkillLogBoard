...
day: "day3"
slice: "03_asset_path_resolver"
title: "asset path resolver"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 03_asset_path_resolver — asset path resolver

## Objective

Implement robust asset path resolution for report package mode.
...
- src/skilllogboard/report/assets.py
- src/skilllogboard/report/manifest.py
- tests/test_report_assets.py

## Implementation Steps

1. Create asset registry/resolver for CSS, JS, images, figures, tables.
2. Ensure relative paths are stable after copying the report folder.
3. Prevent absolute paths from leaking into report HTML by default.
4. Add tests.

## Acceptance Criteria

- Asset resolver exists.
- Report package uses relative paths.
- Absolute local paths are avoided unless explicitly requested.
- Tests pass.

## Verification Commands

```bash
pytest -q tests/test_report_assets.py
```
