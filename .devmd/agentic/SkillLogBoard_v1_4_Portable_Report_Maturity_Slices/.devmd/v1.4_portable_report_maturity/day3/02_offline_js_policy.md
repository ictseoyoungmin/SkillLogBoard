...
day: "day3"
slice: "02_offline_js_policy"
title: "offline JS policy"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 02_offline_js_policy — offline JS policy

## Objective

Define and implement offline JS policy for static reports.
...
1. Ensure minimal mode does not require JS.
2. If portable_interactive mode exists, use vendored/inline JS only.
3. Do not use external CDN.
4. Document file-size tradeoff.
5. Add tests for no external script URLs.

## Acceptance Criteria

- Minimal mode works without JS.
- Interactive mode has no CDN dependency.
