...
day: "day3"
slice: "04_static_html_security_sanity"
title: "static HTML security sanity"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 04_static_html_security_sanity — static HTML security sanity

## Objective

Add basic safety checks for static HTML rendering.
...
1. Escape user-provided strings in templates.
2. Avoid arbitrary raw HTML insertion unless explicitly marked safe.
3. Ensure local file paths are displayed as text, not executed.
4. Add tests with special characters.

## Acceptance Criteria

- Report rendering escapes unsafe text.
- No arbitrary script injection path is introduced.
- Tests pass.
