...
day: "day2"
slice: "02_provenance_model"
title: "report provenance model"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 02_provenance_model — report provenance model

## Objective

Implement source provenance model for tables and figures.
...
- src/skilllogboard/report/provenance.py
- src/skilllogboard/report/manifest.py
- tests/test_report_provenance.py

## Implementation Steps

1. Define provenance fields: source_file, source_kind, metrics, columns, step_range, row_range, transform, generated_by.
2. Add helper to attach provenance to figure/table artifacts.
3. Keep line-level provenance optional.
4. Add tests for metric and table provenance.

## Acceptance Criteria

- Provenance model exists.
- Figure/table provenance can be serialized.
- Line-level provenance is optional and documented.
- Tests pass.

## Verification Commands

```bash
pytest -q tests/test_report_provenance.py tests/test_report_manifest.py
```
