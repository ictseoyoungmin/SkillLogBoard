...
day: "day2"
slice: "01_report_manifest_schema_v2"
title: "report manifest schema v2"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 01_report_manifest_schema_v2 — report manifest schema v2

## Objective

Define and implement a stronger report_manifest.yaml schema.
...
- src/skilllogboard/report/spec.py
- tests/test_report_manifest.py
- docs/report_artifacts.md

## Implementation Steps

1. Define manifest sections: report, run, inputs, figures, tables, assets, provenance, generated_at, versions.
2. Add schema writer/reader helpers.
3. Preserve backward-compatible reading of old manifest fields.
4. Add tests for required and optional fields.

## Acceptance Criteria

- Manifest schema v2 exists.
- Writer and reader are tested.
