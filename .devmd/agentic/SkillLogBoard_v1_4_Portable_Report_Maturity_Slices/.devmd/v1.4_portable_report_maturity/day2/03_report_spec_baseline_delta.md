...
day: "day2"
slice: "03_report_spec_baseline_delta"
title: "ReportSpec baseline delta fields"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 03_report_spec_baseline_delta — ReportSpec baseline delta fields

## Objective

Add baseline/reference-run comparison fields to ReportSpec.
...
1. Add optional baseline_run_id or baseline selector to ReportSpec.
2. Add delta metric output policy.
3. Support absolute and percentage deltas in report tables.
4. Document that delta is descriptive, not causal.

## Acceptance Criteria

- ReportSpec can express baseline comparison.
- Delta table policy is documented.
- Tests pass.
