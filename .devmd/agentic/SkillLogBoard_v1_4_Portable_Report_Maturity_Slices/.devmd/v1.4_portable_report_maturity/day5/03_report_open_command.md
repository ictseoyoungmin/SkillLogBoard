...
day: "day5"
slice: "03_report_open_command"
title: "report open command"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 03_report_open_command — report open command

## Objective

Add a convenience command to open generated static reports locally.
...
1. Add `skilllog report open RUN_DIR` if consistent with CLI style.
2. Open report.html or print path when browser opening is disabled.
3. Avoid requiring a server.
4. Add tests for path resolution.

## Acceptance Criteria

- Report open command exists or is documented as deferred.
- Command does not require server.
- Tests pass.
