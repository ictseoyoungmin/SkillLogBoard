...
day: "day5"
slice: "02_report_validate_json_output"
title: "report validation JSON output"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 02_report_validate_json_output — report validation JSON output

## Objective

Make report validation output agent-friendly.
...
1. Add optional `--json` output for validation errors.
2. Use structured error codes.
3. Include path, message, severity, suggested_action.
4. Add tests.

## Acceptance Criteria

- Validation can emit JSON.
