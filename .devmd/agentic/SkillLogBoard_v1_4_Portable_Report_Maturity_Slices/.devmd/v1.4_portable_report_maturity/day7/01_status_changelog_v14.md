...
day: "day7"
slice: "01_status_changelog_v14"
title: "status and changelog v1.4"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 01_status_changelog_v14 — status and changelog v1.4

## Objective

Update status matrix and changelog for v1.4.
...
1. Add v1.4 Portable Report Maturity entry.
2. Mark rendering modes, provenance, report package, validation, offline tests.
3. Keep claims honest.

## Acceptance Criteria

- CHANGELOG includes v1.4.
- Status matrix reflects v1.4.
...
print('v1.4 changelog check passed')
PY
```
