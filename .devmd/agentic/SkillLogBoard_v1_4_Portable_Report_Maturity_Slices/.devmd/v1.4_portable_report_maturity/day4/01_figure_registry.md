...
day: "day4"
slice: "01_figure_registry"
title: "figure registry"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 01_figure_registry — figure registry

## Objective

Create a figure registry for generated report figures.
...
1. Define figure metadata fields: name, path, title, source, metric, renderer, provenance.
2. Register metric curve figures.
3. Register compare overlay figures if available.
4. Add tests.

## Acceptance Criteria

- Figure registry exists.
- Figures are listed in manifest.
- Tests pass.
