...
# 02_table_registry — table registry

## Objective

Create a table registry for report tables.
...
- src/skilllogboard/report/tables.py
- src/skilllogboard/report/manifest.py
- tests/test_report_tables.py

## Implementation Steps

1. Define table metadata fields: name, path, columns, source, transform, provenance.
2. Register leaderboard table.
3. Register config table.
4. Register baseline delta table if spec requests it.
5. Add tests.

## Acceptance Criteria

- Table registry exists.
- Tables are listed in manifest.
- Tests pass.
