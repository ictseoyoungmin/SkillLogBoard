...
day: "day4"
slice: "04_static_svg_fallback"
title: "static SVG fallback"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 04_static_svg_fallback — static SVG fallback

## Objective

Provide SVG fallback figures for minimal portable mode.
...
- src/skilllogboard/report/figures.py
- src/skilllogboard/report/render.py
- tests/test_report_figures.py

## Implementation Steps

1. Generate simple SVG metric curves without external libraries.
2. Use fallback when interactive chart renderer is unavailable.
3. Ensure SVG output is deterministic enough for tests.
4. Add tests.

## Acceptance Criteria

- Minimal mode can render figures without JS.
- SVG fallback is deterministic.
- Tests pass.

## Verification Commands

```bash
pytest -q tests/test_report_figures.py tests/test_report_rendering.py
```
