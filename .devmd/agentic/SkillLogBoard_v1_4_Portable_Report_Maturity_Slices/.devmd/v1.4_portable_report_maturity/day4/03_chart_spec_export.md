...
day: "day4"
slice: "03_chart_spec_export"
title: "chart spec export"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 03_chart_spec_export — chart spec export

## Objective

Export chart specifications for report reproducibility.
...
- src/skilllogboard/report/charts.py
- src/skilllogboard/report/manifest.py
- tests/test_report_charts.py

## Implementation Steps

1. Define lightweight chart spec JSON for scalar curves and compare overlays.
2. Store spec under report/chart_specs/ or in manifest when small.
3. Keep renderer-agnostic where possible.
4. Add tests.

## Acceptance Criteria

- Chart specs are emitted.
- Specs are linked from manifest.
- Tests pass.

## Verification Commands

```bash
pytest -q tests/test_report_charts.py
```
