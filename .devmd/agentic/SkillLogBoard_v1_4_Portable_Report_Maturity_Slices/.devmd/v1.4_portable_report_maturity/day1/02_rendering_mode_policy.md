...
day: "day1"
slice: "02_rendering_mode_policy"
title: "rendering mode policy"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 02_rendering_mode_policy — rendering mode policy

## Objective

Define static rendering modes: minimal, portable_interactive, and package.
...
1. Add or document `render_mode` values.
2. Define mode behavior for CSS, JS, chart rendering, and asset paths.
3. Set minimal or package as safe default according to existing behavior.
4. Add tests for valid/invalid render modes.

## Acceptance Criteria

- Rendering modes are explicit.
- Default mode is documented.
- Invalid mode is rejected or normalized.
- Tests pass.
