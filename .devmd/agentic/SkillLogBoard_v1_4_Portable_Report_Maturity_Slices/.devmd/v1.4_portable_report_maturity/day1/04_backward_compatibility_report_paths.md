...
day: "day1"
slice: "04_backward_compatibility_report_paths"
title: "backward compatibility for report paths"
priority: "P0"
status: "completed"
target_version: "v1.4"
---

# 04_backward_compatibility_report_paths — backward compatibility for report paths

## Objective

Ensure v1.4 report package changes do not break existing v0.7-v1.3 report paths.
...
1. Support root-level report files if already generated.
2. Support report/ subdirectory package.
3. Ensure Live Board artifact reader can discover both.
4. Add tests for both layouts.

## Acceptance Criteria

- Old and new report paths are readable.
- Live Board can find v1.4 report package.
- Tests pass.
