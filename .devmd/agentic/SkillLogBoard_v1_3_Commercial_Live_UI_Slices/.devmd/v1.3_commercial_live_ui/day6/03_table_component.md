...
# 03_table_component — table component

## Objective

Implement or integrate table component for Runs and compare tables.
...
1. Decide between TanStack Table and lightweight custom table.
2. If adding dependency, document why.
3. Support sortable columns and column visibility if feasible.
4. Keep bundle cost reasonable.
5. Use component in Runs view.

## Acceptance Criteria

- Table component exists.
- Dependency decision is documented if applicable.
- Runs table uses it.
- Build passes.
