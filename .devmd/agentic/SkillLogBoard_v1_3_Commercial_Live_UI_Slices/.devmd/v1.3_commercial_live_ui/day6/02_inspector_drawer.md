...
# 02_inspector_drawer — inspector drawer

## Objective

Implement reusable inspector drawer.
...
- frontend/live-board/src/components/InspectorDrawer.tsx
- frontend/live-board/src/state/

## Implementation Steps

1. Create inspector for run detail, artifact preview, report metadata, agent file metadata.
2. Use metadata-first rendering.
3. Avoid unsafe file content preview.
4. Make close/focus behavior accessible.

## Acceptance Criteria

- Inspector drawer is reusable.
- Metadata-first policy is maintained.
- Build passes.
