...
day: "day7"
slice: "04_api_contract_compatibility"
...
# 04_api_contract_compatibility — API contract compatibility

## Objective

Ensure v1.3 frontend does not require breaking backend changes.
...
1. Compare TypeScript API expectations with server responses.
2. Add backend tests for fields required by frontend.
3. Handle missing optional fields gracefully in frontend.
4. Document API version.

## Acceptance Criteria

- Frontend handles optional fields.
- Backend tests cover required fields.
- API version or schema docs exist.
