...
day: "day4"
slice: "02_metric_lab_commercial_view"
title: "commercial Metric Lab view"
priority: "P0"
status: "completed"
target_version: "v1.3"
---

# 02_metric_lab_commercial_view — commercial Metric Lab view

## Objective

Implement polished Metric Lab scalar exploration view.
...
- frontend/live-board/src/views/MetricLabView.tsx
- frontend/live-board/src/components/charts/

## Implementation Steps

1. Render expanded scalar chart.
2. Render metric catalog with groups/search/pins.
3. Render smoothing/outlier/compare overlay controls if supported.
4. Render marker legend and cursor summary.
5. Avoid unsupported diagnosis language.

## Acceptance Criteria

- Metric Lab is useful and polished.
- Metric catalog exists.
- Controls map to actual behavior.
- Build passes.
