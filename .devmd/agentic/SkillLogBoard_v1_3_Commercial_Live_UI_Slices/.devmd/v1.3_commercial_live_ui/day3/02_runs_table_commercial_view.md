...
day: "day3"
slice: "02_runs_table_commercial_view"
title: "commercial Runs table view"
priority: "P0"
status: "completed"
target_version: "v1.3"
---

# 02_runs_table_commercial_view — commercial Runs table view

## Objective

Implement polished Runs table view inspired by MLflow/W&B.
...
- frontend/live-board/src/components/table/

## Implementation Steps

1. Render run table with status, key metrics, branch/tag, artifact count, notes.
2. Add filter/search controls.
3. Add column visibility affordance.
4. Allow selecting runs for Compare.
5. Keep table performant for many runs; use virtualization if library selected.

## Acceptance Criteria

- Runs table is usable and polished.
