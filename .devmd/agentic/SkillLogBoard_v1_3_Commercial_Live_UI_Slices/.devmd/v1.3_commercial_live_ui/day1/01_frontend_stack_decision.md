...
day: "day1"
slice: "01_frontend_stack_decision"
title: "frontend stack decision record"
priority: "P0"
status: "completed"
target_version: "v1.3"
---

# 01_frontend_stack_decision — frontend stack decision record

## Objective

Create an architecture decision record for the v1.3 frontend stack.
...
- docs/adr/live_board_frontend_stack.md
- pyproject.toml
- README.md

## Implementation Steps

1. Document React + TypeScript + Vite recommendation.
2. Document why GraphQL/Redux/cloud architecture is not used.
3. Document how compiled assets will be packaged for Python users.
4. Document fallback if Node tooling is unavailable.

## Acceptance Criteria

- ADR exists.
- Decision separates source development from installed runtime.
- Local-first boundaries are explicit.
...
text = Path('docs/adr/live_board_frontend_stack.md').read_text(encoding='utf-8').lower()
assert 'react' in text and 'vite' in text and 'local' in text
print('frontend stack ADR check passed')
PY
```
