...
# 02_app_shell_components — app shell components

## Objective

Implement reusable app shell components.
...
1. Implement Sidebar, Topbar, CapabilityRibbon, InspectorDrawer, CommandPalette shell hooks.
2. Group navigation into Project, Analysis, Evidence.
3. Use local-first sidebar footer.
4. Keep keyboard command palette affordance.
5. Add responsive behavior.

## Acceptance Criteria

- App shell renders all nav groups.
- Command palette shell exists.
- Inspector drawer shell exists.
