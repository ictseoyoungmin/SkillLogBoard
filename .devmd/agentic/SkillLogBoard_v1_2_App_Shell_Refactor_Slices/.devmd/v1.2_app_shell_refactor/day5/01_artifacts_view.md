...
# 01_artifacts_view — Artifacts view

## Objective

Implement a dedicated Artifacts view.
...
1. Render grouped artifact grid: reports, figures, tables, checkpoints, logs, other.
2. Add filters/search by type/run/tag.
3. Show metadata preview drawer.
4. Avoid unsafe arbitrary file serving.
5. Add tests.

## Acceptance Criteria

- Artifacts view exists.
- Artifact groups are visible.
- Preview is metadata-first.
- Tests pass.
