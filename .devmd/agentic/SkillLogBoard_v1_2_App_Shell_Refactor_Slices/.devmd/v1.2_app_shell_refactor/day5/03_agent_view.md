...
# 03_agent_view — Agent view

## Objective

Implement a dedicated Agent Evidence view.
...
1. Render agent action timeline.
2. Render safety gate/rule status if available.
3. Render handoff and decisions file status.
4. Render local evidence paths.
5. Do not claim the app runs agents itself.
6. Add tests.

## Acceptance Criteria

- Agent view exists.
- Agent evidence is local-file based.
- No LLM execution claim is made.
- Tests pass.
