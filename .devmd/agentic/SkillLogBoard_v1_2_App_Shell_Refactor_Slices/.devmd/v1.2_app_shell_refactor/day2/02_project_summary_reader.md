...
day: "day2"
slice: "02_project_summary_reader"
...
# 02_project_summary_reader — project summary reader

## Objective

Implement summary-first project state for Overview.
...
1. Create project summary helper with run count, status counts, shared metrics, compare readiness, artifact availability, agent evidence availability, alerts.
2. Read manifest and lightweight metric summaries only.
3. Avoid full metric series reading.
4. Add tests with many run directories.

## Acceptance Criteria

- Project summary contains key overview fields.
- Full metric series is not required for summary.
- Large project fixture remains fast enough for unit tests.
- Tests pass.
