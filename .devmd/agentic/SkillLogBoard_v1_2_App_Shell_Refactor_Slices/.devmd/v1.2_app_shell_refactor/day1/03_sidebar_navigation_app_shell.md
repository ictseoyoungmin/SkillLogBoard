...
day: "day1"
slice: "03_sidebar_navigation_app_shell"
title: "sidebar navigation app shell"
priority: "P0"
status: "completed"
target_version: "v1.2"
---

# 03_sidebar_navigation_app_shell — sidebar navigation app shell

## Objective

Convert the existing navigation into an app shell sidebar with real view switching.
...
1. Create sidebar groups: Project, Analysis, Evidence.
2. Add nav items: Overview, Runs, Compare, Metric Lab, Artifacts, Reports, Agent, Local Settings.
3. Make nav item active state follow `currentView`.
4. Keep local-first status card in sidebar.
5. Avoid account/avatar/team language.
6. Add tests for sidebar structure and local-first language.

## Acceptance Criteria

- Sidebar groups exist.
- All target views are reachable.
- Active nav state is represented.
- No cloud/account language is introduced.
- Tests pass.
