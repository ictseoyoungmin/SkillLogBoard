...
day: "day1"
slice: "01_current_ui_inventory"
title: "current UI inventory and preservation map"
priority: "P0"
status: "completed"
target_version: "v1.2"
---

# 01_current_ui_inventory - current UI inventory and preservation map

## Objective

Inventory the current v1.1.2 Live Board UI functions and decide where each belongs in the v1.2 app shell.
...
1. List current UI regions and interactions: capability hints, metric workspace, compare, tray, drawer, artifact preview, agent panel.
2. Map each current region into a target v1.2 view.
3. Identify UI pieces that should remain shared components.
4. Document preservation requirements to avoid accidental feature regression.

## Acceptance Criteria

- Inventory is documented.
- Every major v1.1.2 feature has a target v1.2 view.
- Shared components are identified.
- No code deletion occurs in this slice.
...
assert Path('src/skilllogboard/live/templates/live.html').exists()
print('inventory precheck passed')
PY
```
