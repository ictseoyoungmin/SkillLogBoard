...
day: "day4"
slice: "04_compare_baseline_delta_ui"
title: "baseline delta UI"
priority: "P0"
status: "completed"
target_version: "v1.2"
---

# 04_compare_baseline_delta_ui — baseline delta UI

## Objective

Expose baseline/reference run delta in Compare UI where data is available.
...
1. Identify baseline run by role/tag or selected baseline.
2. Calculate final metric delta and delta percent for selected metric.
3. Render delta table in Compare view.
4. Document that this is metric-level comparison, not causal analysis.
5. Add tests.

## Acceptance Criteria

- Baseline run can be represented.
- Compare table shows delta and delta percent.
- No unsupported analysis claims appear.
- Tests pass.

## Verification Commands

```bash
pytest -q tests/test_live_project.py tests/test_live_ui_snapshot.py
```
