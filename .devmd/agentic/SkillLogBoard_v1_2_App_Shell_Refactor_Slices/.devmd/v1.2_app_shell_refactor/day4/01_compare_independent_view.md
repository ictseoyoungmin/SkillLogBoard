...
day: "day4"
slice: "01_compare_independent_view"
title: "Compare independent view"
priority: "P0"
status: "completed"
target_version: "v1.2"
---

# 01_compare_independent_view — Compare independent view

## Objective

Move Compare into its own first-class screen.
...
1. Render Compare as its own view with run picker, metric selector, overlay chart, legend, and summary table.
2. Use `/api/compare` or view-scoped compare state.
3. Ensure compare controls are not merely decorative.
4. Add tests for compare screen landmarks.

## Acceptance Criteria

- Compare view is independent.
- Overlay chart uses selected metric/runs state.
- Legend and summary are visible.
- Tests pass.
