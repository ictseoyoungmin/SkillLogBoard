...
# 02_changelog_v12 — changelog v1.2

## Objective

Add v1.2 changelog entry.
...
1. Add v1.2 App Shell Refactor entry.
2. Mention view routing, project overview default, view-scoped state, and lazy loading.
3. Keep wording honest about what is implemented.

## Acceptance Criteria

- CHANGELOG includes v1.2.
...
assert '1.2' in text or 'v1.2' in text
print('v1.2 changelog check passed')
PY
```
