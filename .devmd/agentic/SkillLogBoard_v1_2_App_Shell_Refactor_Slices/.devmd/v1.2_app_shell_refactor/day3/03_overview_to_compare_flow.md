...
day: "day3"
slice: "03_overview_to_compare_flow"
title: "Overview-to-Compare flow"
priority: "P0"
status: "completed"
target_version: "v1.2"
---

# 03_overview_to_compare_flow — Overview-to-Compare flow

## Objective

Make Compare discoverable from Overview without cluttering the default screen.
...
1. Add `Compare runs` action from Overview.
2. Show compare-readiness hint based on actual state.
3. Preserve selected runs when navigating from Runs/Overview to Compare.
4. Add tests for navigation affordance.

## Acceptance Criteria

- Overview has clear Compare action.
- Compare readiness is data-backed.
- Selected run state is preserved in frontend state where feasible.
- Tests pass.
