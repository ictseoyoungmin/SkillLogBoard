...
day: "day3"
slice: "04_local_settings_view"
title: "Local Settings view"
priority: "P0"
status: "completed"
target_version: "v1.2"
---

# 04_local_settings_view — Local Settings view

## Objective

Implement local-only settings view without account/cloud metaphors.
...
1. Add Local Settings view with refresh interval, preference scope, default view, storage mode.
2. Avoid account/team/cloud/avatar language.
3. Add reset local preferences action if already available.
4. Document local settings behavior.

## Acceptance Criteria

- Settings view exists.
- All wording is local-first.
- Preference reset is visible if supported.
- Tests pass.
