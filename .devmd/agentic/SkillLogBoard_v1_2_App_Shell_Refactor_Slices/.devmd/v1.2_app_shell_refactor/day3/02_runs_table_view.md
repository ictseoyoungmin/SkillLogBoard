...
day: "day3"
slice: "02_runs_table_view"
title: "Runs table view implementation"
priority: "P0"
status: "completed"
target_version: "v1.2"
---

# 02_runs_table_view — Runs table view implementation

## Objective

Implement a dedicated Runs view inspired by MLflow/W&B run tables.
...
1. Render run table with status, key metric, duration, branch/tag, artifact count, warning count.
2. Add filter/search controls as local UI affordances.
3. Support selecting runs for Compare.
4. Keep behavior static/vanilla if no full table library exists.
5. Add tests for table columns and selection affordance.

## Acceptance Criteria

- Runs view exists.
- Run table fields are visible.
- Selected runs can feed Compare state.
- Tests pass.
