...
day: "day3"
slice: "01_project_overview_view"
title: "Project Overview view implementation"
priority: "P0"
status: "completed"
target_version: "v1.2"
---

# 01_project_overview_view — Project Overview view implementation

## Objective

Implement Overview as the default project landing page.
...
1. Render project command center with run count, best metric, shared metrics, evidence, warnings.
2. Render compact run health list.
3. Render capability hints.
4. Render onboarding card for rich demo command.
5. Ensure Overview is not overloaded with full detail panels.

## Acceptance Criteria

- Overview looks like a project root view.
- Key project summary is visible.
- No hidden compare/lab confusion.
- Tests pass.
