...
day: "day6"
slice: "01_lazy_loading_frontend_flow"
title: "frontend lazy loading flow"
priority: "P0"
status: "completed"
target_version: "v1.2"
---

# 01_lazy_loading_frontend_flow — frontend lazy loading flow

## Objective

Make frontend request state per view instead of refreshing everything eagerly.
...
1. Update frontend state loading to request view-scoped data when views change.
2. Keep polling only for active/current view where feasible.
3. Cache recent view payloads in memory.
4. Allow manual refresh to reload current view.
5. Add tests for API endpoint references.

## Acceptance Criteria

- Frontend uses view-scoped state requests.
- Inactive heavy views are not continuously refreshed.
