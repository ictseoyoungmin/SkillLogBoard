...
day: "day6"
slice: "04_cli_watch_project_guidance"
title: "CLI project/run guidance"
priority: "P0"
status: "completed"
target_version: "v1.2"
---

# 04_cli_watch_project_guidance — CLI project/run guidance

## Objective

Improve CLI/watch guidance so users understand project vs single-run mode.
...
1. Clarify `skilllog watch RUN_DIR` vs `skilllog watch PROJECT_DIR --project`.
2. Print or document which default view will open.
3. Add rich demo project command.
4. Add CLI tests for help text if feasible.

## Acceptance Criteria

- CLI docs reduce project/run confusion.
- Help or docs explain default views.
- Tests pass.
