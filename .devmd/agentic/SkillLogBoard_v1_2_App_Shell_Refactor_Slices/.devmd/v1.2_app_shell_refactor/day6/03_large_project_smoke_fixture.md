...
day: "day6"
slice: "03_large_project_smoke_fixture"
title: "large project smoke fixture"
priority: "P0"
status: "completed"
target_version: "v1.2"
---

# 03_large_project_smoke_fixture — large project smoke fixture

## Objective

Add a large-project test fixture for 50+ runs.
...
1. Create synthetic fixture with 50+ runs and metrics summaries.
2. Assert Overview summary remains bounded.
3. Assert Compare selected metric remains bounded.
4. Assert runtime is acceptable for unit tests.
5. Do not rely on real long-running examples.

## Acceptance Criteria

- Large-project fixture exists.
- Overview and Compare remain bounded.
- Tests pass quickly.
