...
day: "day6"
slice: "02_metric_summary_cache"
title: "metric summary cache"
priority: "P0"
status: "completed"
target_version: "v1.2"
---

# 02_metric_summary_cache — metric summary cache

## Objective

Add lightweight metric summary caching or throttling to reduce repeated file reads.
...
1. Add mtime-based lightweight cache or throttled summary computation if safe.
2. Cache only derived summary metadata, not stale full state that hides changes.
3. Invalidate on mtime change.
4. Keep implementation simple and local.
5. Add tests for cache hit/invalidation if feasible.

## Acceptance Criteria

- Repeated summary reads are reduced or throttled.
- Cache invalidates on file changes.
- Implementation does not require a DB.
- Tests pass.
